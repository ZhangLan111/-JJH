        ...
        <form name="audit_form" method="post" class="c-form" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="value"><input type="file" name="uploadIndex" id="noticeMemo"
...
<script>
    ...
    !function () {
        getCurrWin().find('.auditsave').on('click', function (e) {
            if($("#noticeMemo").val().length==0){
                alert("请选择要上传的图片！");
                return;
            }
            $.ajaxFileUpload({
                url:'/jjh/notice/uploadIndexImg.do?notice_id='+${noticeId},
                fileElementId :'noticeMemo',
                dataType:'text',
