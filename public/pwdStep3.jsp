...
<div id="c-w" class="float-wrapper">
    <div class="title">
        <span class="i-home"></span> <a href="/login.shtml">首页</a> <span class="i-arrow"></span> <a href="pwdStep1.jsp">填写邮箱</a> <span class="i-arrow"></span> <a href="pwdStep2.shtml">接收验证邮件</a> <span class="i-arrow"></span> <a href="#">找回密码</a> <a href="/" class="r-l">返回首页</a>
    </div>
        ...
        <div data-options="region:'center'" >
            <form id="user_password_form" style="margin: 3px">
                ...
                <table class="table">
                    <tbody>
                    <tr>
                        <td colspan="2" align="center"><img src="/static/system/img/step3.png"></td>
                    </tr>
                    <tr>
