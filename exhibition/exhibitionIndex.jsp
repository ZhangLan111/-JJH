        ...
        <form name="audit_form" method="post" class="c-form" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="value">${exhibition_activity_title}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value"><input type="file" name="uploadIndex" id="exhibition_activity_pic"
...
<script>
    ...
    !function () {
        getCurrWin().find('.auditsave').on('click', function (e) {
            if($("#exhibition_activity_pic").val().length==0){
                alert("请选择要上传的图片！");
                return;
            }
            $.ajaxFileUpload({
                url:'/jjh/exhibition/uploadIndexImg.do?exhibitionActivityId='+${exhibition_activity_id},
                fileElementId :'exhibition_activity_pic',
                dataType:'text',
