        ...
        <form name="audit_form" method="post" class="c-form" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="value">${vactivity_name}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value"><input type="file" name="uploadIndex" id="vactivityPic"
...
<script>
    ...
    !function () {
        getCurrWin().find('.auditsave').on('click', function (e) {
            if($("#vactivityPic").val().length==0){
                alert("请选择要上传的图片！");
                return;
            }
            $.ajaxFileUpload({
                url:'/jjh/vactivity/uploadIndexImg.do?vactivityId='+${vactivity_id},
                fileElementId :'vactivityPic',
                dataType:'text',
